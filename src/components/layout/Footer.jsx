...
export default function Footer() {
  return (
    ...
    >
      <a
        href="https://github.com/SiliconBeachIN/git-simulator"
        target="_blank"
      ...
      <a href="/privacy" style={{ color: T.subtleText, fontSize: 11, textDecoration: "none" }}>
        Privacy Policy
      </a>
      <span style={{ color: T.subtleText, fontSize: 11 }}>|</span>
      <a href="/terms" style={{ color: T.subtleText, fontSize: 11, textDecoration: "none" }}>
        Terms of Service
      </a>
      <span style={{ color: T.subtleText, fontSize: 11 }}>|</span>

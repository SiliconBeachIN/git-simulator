  ...
  return (
    <div>
      ...
      <InfoBox icon="💡" title="Branches are just pointers — they cost nothing" color={T.green}>
        A branch is literally a <strong style={{ color: T.green }}>41-byte text file</strong>{" "}
        containing a commit hash. That's it. When you create a branch, Git writes one tiny
        file. When you commit on a branch, Git moves that pointer forward.
      </InfoBox>
